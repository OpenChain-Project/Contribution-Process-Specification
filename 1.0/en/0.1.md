...
- 3.2.X.1 - Document with name of persons, group or function in program role(s) identified.
- 3.2.X.2 - The identified program roles have been properly staffed and adequate funding provided.
- 3.2.X.3 - Identification of expertise available to address contribution matters which could be internal or external.
